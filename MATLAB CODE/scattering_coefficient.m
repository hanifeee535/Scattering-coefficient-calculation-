...
switch plot_reim  
    ...
    %T2CC
        ...
        legend('\Ree(T_{2N}^{CC})','\Imm(T_{2N}^{CC})','\Ree(T_{2Ns}^{CC})','\Imm(T_{2Ns}^{CC})');
        ...
        plot (real(ys1), imag (T2CSs.*h2s./c1.^2), 'Color', '[1 0 1]', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Ree(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ylabel('T_{2}^{Cs}', 'FontWeight','Bold', 'FontSize',fs);
        legend('\Ree(T_{2N}^{Cs})','\Imm(T_{2N}^{Cs})','\Ree(T_{2Ns}^{Cs})','\Imm(T_{2Ns}^{Cs})');
        ...
        legend('\Ree(T_{2N}^{sc})','\Imm(T_{2N}^{sc})','\Ree(T_{2Ns}^{sc})','\Imm(T_{2Ns}^{sc})');
        ...
        legend('\Ree(T_{2N}^{ss})','\Imm(T_{2N}^{ss})','\Ree(T_{2Ns}^{ss})','\Imm(T_{2Ns}^{ss})');
        
    
    case{1} %Real /imaginary part on two figure
        % T2CC
        figure('NumberTitle','off', 'Name',' Re T_2N^CC');
        plot (real(c3), real (T2CC./c1.^5), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(c3), real (T2CCs./c1.^5), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Ree (k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ylabel(' Re T_{2}^{CC}', 'FontWeight','Bold', 'FontSize',fs);
        legend('\Ree(T_{2N}^{CC})','\Ree(T_{2Ns}^{CC})');
        
        
        figure('NumberTitle','off', 'Name',' Im T_2N^CC');
        plot (real(c3), imag (T2CC./c1.^5), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(ys1), imag (T2CCs./c1.^5), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Im(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ylabel(' Im T_{2}^{CC}', 'FontWeight','Bold', 'FontSize',fs);
        legend('\Im(T_{2N}^{CC})','\Im(T_{2Ns}^{CC})');
        
        % T2CS
        figure('NumberTitle','off', 'Name',' Re T_2N^CS');
        plot (real(c3), real (T2CS.*h2s./c1.^2), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(c3), real (T2CSs.*h2s./c1.^2), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Ree(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ylabel(' Re T_{2}^{CS}', 'FontWeight','Bold', 'FontSize',fs);
        legend('\Ree(T_{2N}^{CS})','\Ree(T_{2Ns}^{CS})');
        
        
        figure('NumberTitle','off', 'Name',' Im T_2N^CS');
        ...
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Im(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ylabel(' Im T_{2}^{CS}', 'FontWeight','Bold', 'FontSize',fs);
        legend('\Im(T_{2N}^{CS})','\Im(T_{2Ns}^{CS})');
        
        % T2SC
        figure('NumberTitle','off', 'Name',' Re T_2N^SC');
        plot (real(c3), real (T2SC./j2s./c1.^3), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(ys1), real (T2SCs./j2s./c1.^3), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Ree(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ylabel(' Re T_{2}^{SC}', 'FontWeight','Bold', 'FontSize',fs);
        legend('\Ree(T_{2N}^{SC})','\Ree(T_{2Ns}^{SC})');
        
        
        figure('NumberTitle','off', 'Name',' Im T_2N^SC');
        plot (real(ys1), imag (T2SC./j2s./c1.^3), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(ys1), imag (T2SCs./j2s./c1.^3), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Im(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ylabel(' Im T_{2}^{SC}', 'FontWeight','Bold', 'FontSize',fs);
        legend('\Im(T_{2N}^{SC})','\Im(T_{2Ns}^{SC})');
        
         % T2SS
        figure('NumberTitle','off', 'Name',' Re T_2N^SS');
        plot (real(c3), real (T2SS.*h2s./j2s), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(c3), real (T2SSa.*h2s./j2s), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Ree(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ylabel(' Re T_{2}^{SS}', 'FontWeight','Bold', 'FontSize',fs);
        legend('\Ree(T_{2N}^{SS})','\Ree(T_{2Ns}^{SS})');
        
        
        figure('NumberTitle','off', 'Name',' Im T_2N^SS');
        plot (real(c3), imag (T2SS.*h2s./j2s), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(c3), imag (T2SS.*h2s./j2s), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Im(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ylabel(' Im T_{2}^{SS}', 'FontWeight','Bold', 'FontSize',fs);
        legend('\Im(T_{2N}^{SS})','\Im(T_{2Ns}^{SS})');
    ...
    case {2}
        ...
        plot (real(c3), abs (T2CC./c1.^5), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(c3), abs (T2CCs./c1.^5), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Ree(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ...
        plot (real(c3), angle (T2CC./c1.^5), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(c3), angle (T2CCs./c1.^5), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Ree(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ylabel(' T_{2N}^{CC}', 'FontWeight','Bold', 'FontSize',fs);
        ...
        plot (real(c3), abs (T2CS.*h2s./c1.^2), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(c3), abs (T2CSs.*h2s./c1.^2), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Ree(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ...
        plot (real(c3), angle (T2CS.*h2s./c1.^2), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(c3), angle (T2CSs.*h2s./c1.^2), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Ree(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ylabel(' T_{2N}^{CS}', 'FontWeight','Bold', 'FontSize',fs);
        ...
        plot (real(c3), abs (T2SC./j2s./c1.^3), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(c3), abs (T2SCs./j2s./c1.^3), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Ree(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ...
        plot (real(c3), angle (T2SC./j2s./c1.^3), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(c3), angle (T2SCs./j2s./c1.^3), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Ree(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ylabel(' T_{2N}^{SC}', 'FontWeight','Bold', 'FontSize',fs);
        ...
        plot (real(c3), abs (T2SS.*h2s./j2s), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(c3), abs (T2SSs.*h2s./j2s), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Ree(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ...
        plot (real(c3), angle (T2SS.*h2s./j2s), 'Color', '[0 1 1]', 'LineStyle','-','LineWidth',lw);hold on;
        plot (real(c3), angle (T2SSs.*h2s./j2s), 'Color', 'k', 'LineStyle','-','LineWidth',lw);
        set(gca, 'XScale','log', 'YScale','log', 'FontSize',fs);
        set(gca, 'XTick',XT, 'XLim',[min(XT) max(XT)]);
        xlabel ('\Ree(k_{s}a)', 'FontWeight','Bold', 'FontSize',fs);
        ylabel(' T_{2N}^{SC}', 'FontWeight','Bold', 'FontSize',fs);
